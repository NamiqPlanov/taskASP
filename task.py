...
d.connectTo(c)
print(a.getAmount(), b.getAmount(), c.getAmount(),d.getAmount())
c.connectTo(e) 
print(a.getAmount(), b.getAmount(), c.getAmount(),d.getAmount(),e.getAmount())
a.disconnectFrom(c) 
print(a.getAmount(), b.getAmount(), d.getAmount())
print(c.getAmount(),e.getAmount())
